# Generated by Powerlevel10k configuration wizard on 2024-09-11 at 13:29 CST.
...
# Color variables
#OS
typeset -g OS_ICON_FG=4                 # Foreground color for os_icon
typeset -g OS_ICON_BG=237               # Background color for os_icon
#USER_HOST
typeset -g USER_HOST_FG='#00EEFF'       # Foreground color for user and host
typeset -g USER_HOST_BG=0               # Background color for user and host 
#DIR
typeset -g DIR_ANCHOR_BG='#003c3c'      # Background color for directory and anchor
typeset -g DIR_ANCHOR_FG=2              # Foreground color for directory and anchor
typeset -g SHORTEN_DIR_FG=42            # Foreground color for shortened directory
#TIME
typeset -g TIME_FG='#00EEFF'            # Foreground color for time
typeset -g TIME_BG=0                    # Background color for time
#STATUS
typeset -g STATUS_OK_FG=$DIR_ANCHOR_FG  # Foreground color for status ok and status ok pipe
typeset -g STATUS_OK_BG=$DIR_ANCHOR_BG     # Background color for status ok and status ok pipe
typeset -g STATUS_ERROR_FG=196          # Foreground color for status error
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTI LINE_FIRST_PROMPT_GAP_FOREGROUND=238
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$OS_ICON_FG
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=$OS_ICON_BG
  # Custom icon.
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='⭐'

  #################################[ host_user: host and user identifier ]##################################
  typeset -g POWERLEVEL9K_ALWAYS_SHOW_USER=true
typeset -g POWERLEVEL9K_USER_BACKGROUND=$USER_HOST_BG
typeset -g POWERLEVEL9K_USER_FOREGROUND=$USER_HOST_FG
typeset -g POWERLEVEL9K_HOST_BACKGROUND=$USER_HOST_BG
typeset -g POWERLEVEL9K_HOST_FOREGROUND=$USER_HOST_FG
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$DIR_ANCHOR_BG
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$DIR_ANCHOR_FG
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$SHORTEN_DIR_FG
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$DIR_ANCHOR_FG
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=$STATUS_OK_FG
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=$STATUS_OK_BG #'#353A40'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='✔'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=$STATUS_OK_FG
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=$STATUS_OK_BG #'#353A40'

  # Status when it's just an error code (e.g., '1'). No need to show it if prompt_char is enabled as
  # it will signify error by turning red.
  typeset -g POWERLEVEL9K_STATUS_ERROR=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=$STATUS_ERROR_FG
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=$STATUS_OK_BG #'#353A40'
